...
function buildGridOverlay() {
    ...
    var size    = 4;
    var gridSpace = document.getElementById('field-container');
...
function colorSet(value, tile) {
    switch(value) {
        case 2:    tile.style.background = '#E6F5FE'; tile.style.color = '#0199D9'; break;
        case 4:    tile.style.background = '#B5E0FB'; tile.style.color = '#0199D9'; break;
        case 8:    tile.style.background = '#6EC1F6'; tile.style.color = 'white';break;
        case 16:   tile.style.background = '#26A3F2'; tile.style.color = 'white';

            break;
        case 32:   tile.style.background = '#0d6bae'; tile.style.color = 'white'; break;
        case 64:   tile.style.background = '#0C7AC0'; tile.style.color = 'white'; break;
        case 128:  tile.style.background = '#095B8F'; tile.style.color = 'white';
            tile.style.fontSize = '50px'; break;
        case 256:  tile.style.background = '#063D60'; tile.style.color = 'white';
            tile.style.fontSize = '50px'; break;
        case 512:  tile.style.background = '#074804'; tile.style.color = 'white';
            tile.style.fontSize = '40px'; break;
        case 1024: tile.style.background = '#0C7707'; tile.style.color = 'white';
            tile.style.fontSize = '35px'; break;
        case 2048: tile.style.background = '#13C10B'; tile.style.color = 'white';
            tile.style.fontSize = '35px';
            document.getElementById('wonSticker').style.display = 'block'; break;
        case 4096: tile.style.background = '#D80C11'; tile.style.color = 'white';
            tile.style.fontSize = '35px'; break;
        case 8192: tile.style.background = '#F43E42'; tile.style.color = 'white';
            tile.style.fontSize = '35px'; break;
    }
